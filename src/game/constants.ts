...
/** Visual-only ball spin rate (radians per px/s of horizontal speed). */
...
/** Menu-demo backdrop uses much sparser coins so passive pickups stay rare. */
export const MENU_DEMO_COIN_CHANCE = COIN_CHANCE / 10
...
/** Persisted best run score (climb + bonus points). */
export const HIGH_SCORE_KEY = "sling-climb-high-score-v4"
/** World px per climb unit banked into run points. */
