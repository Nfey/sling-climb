...
export const MISSION_POOL: readonly MissionDef[] = [
  ...
  },
  {
    ...
    target: 7,
    reward: 5,
    label: "Collect 7 coins in 1 run",
  },
  {
    id: "easy-platforms-5",
    kind: "platformsFling",
  ...
  {
    id: "easy-coins-fling-3",
    kind: "coinsFling",
    difficulty: "easy",
    target: 3,
    reward: 5,
    label: "Collect 3 coins in one fling",
  },
  {
    id: "easy-catch-3",
    kind: "catchesRun",
  ...
  },
  {
    ...
    target: 8,
    reward: 10,
    label: "Collect 8 coins in 1 run",
  },
  {
    id: "med-arrows-2",
    kind: "arrowsFling",
  ...
  // Hard
  {
    id: "hard-same-bumper-6",
    kind: "sameBumperFling",
    difficulty: "hard",
    target: 6,
    reward: 15,
    label: "Hit the same bumper 6× in one fling",
  },
  {
    id: "hard-portals-5",
    kind: "portalsFling",
  ...
  },
  {
    ...
    target: 14,
    reward: 15,
    label: "Collect 14 coins in 1 run",
  },
  {
    id: "hard-combo-12",
    kind: "comboFling",
  ...
  {
    id: "hard-coins-fling-4",
    kind: "coinsFling",
    difficulty: "hard",
    target: 4,
    reward: 15,
    label: "Collect 4 coins in one fling",
  },
]
