...
export const MISSION_POOL: readonly MissionDef[] = [
  ...
  },
  {
    ...
    target: 2,
    reward: 8,
    label: "Travel through 2 portals in one fling",
  },
  {
    id: "easy-coins-5",
    kind: "coinsRun",
  ...
  },
  {
    ...
    target: 4,
    reward: 8,
    label: "Bounce 4 platforms in one fling",
  },
  {
    id: "easy-bumpers-3",
    kind: "bumpersFling",
    ...
    target: 3,
    reward: 8,
    label: "Hit 3 bumpers in one fling",
  },
  {
    id: "easy-combo-4",
    kind: "comboFling",
    ...
    target: 4,
    reward: 8,
    label: "Reach a 4× combo in one fling",
  },
  {
    id: "easy-coins-fling-2",
    kind: "coinsFling",
    difficulty: "easy",
    target: 2,
    reward: 8,
  ...
  },
  {
    ...
    target: 2,
    reward: 8,
    label: "Catch the ball 2 times in 1 run",
  },
  // Medium
  {
    id: "med-same-bumper-5",
    kind: "sameBumperFling",
    difficulty: "medium",
    target: 5,
    reward: 15,
  ...
  },
  {
    ...
    target: 10,
    reward: 15,
    label: "Collect 10 coins in 1 run",
  },
  {
    id: "med-arrows-3",
    kind: "arrowsFling",
    ...
    target: 3,
    reward: 15,
    label: "Hit 3 arrow pads in one fling",
  },
  {
    id: "med-combo-8",
    kind: "comboFling",
    ...
    target: 8,
    reward: 15,
    label: "Reach an 8× combo in one fling",
  },
  {
    id: "med-height-2500",
    kind: "heightRun",
    ...
    target: 2500,
    reward: 15,
    label: "Climb 2,500 height in 1 run",
  },
  {
    id: "med-bonus-2",
    kind: "bonusRun",
  ...
  },
  {
    ...
    target: 8,
    reward: 15,
    label: "Bounce 8 platforms in one fling",
  },
  // Hard
  {
    id: "hard-same-bumper-8",
    kind: "sameBumperFling",
    difficulty: "hard",
    target: 8,
    reward: 30,
    label: "Hit the same bumper 8× in one fling",
  },
  {
    id: "hard-portals-6",
    kind: "portalsFling",
    ...
    target: 6,
    reward: 30,
    label: "Travel through 6 portals in one fling",
  },
  {
    id: "hard-coins-18",
    kind: "coinsRun",
    ...
    target: 18,
    reward: 30,
    label: "Collect 18 coins in 1 run",
  },
  {
    id: "hard-combo-15",
    kind: "comboFling",
    ...
    target: 15,
    reward: 30,
    label: "Reach a 15× combo in one fling",
  },
  {
    id: "hard-height-6000",
    kind: "heightRun",
    ...
    target: 6000,
    reward: 30,
    label: "Climb 6,000 height in 1 run",
  },
  {
    id: "hard-score-8000",
    kind: "scoreRun",
    ...
    target: 8000,
    reward: 30,
    label: "Score 8,000 points in 1 run",
  },
  {
    id: "hard-bumpers-10",
    kind: "bumpersFling",
    ...
    target: 10,
    reward: 30,
    label: "Hit 10 bumpers in one fling",
  },
  {
    id: "hard-coins-fling-5",
    kind: "coinsFling",
    difficulty: "hard",
    target: 5,
    reward: 30,
    label: "Collect 5 coins in one fling",
  },
]
